...
(12, 'event', 'Event Description', '0', 'proprty_desc', 'Note : Basic HTML tags are allowed', 'Event Description', 'texteditor', 'You should enter description content for your listing.', '', 'Event Description', 12, 1, 0, 1, 1, 'user_side', 0, 0, 'Please enter description of an event.', '', '', 'require'),
(13, 'event', 'How to Register', '0', 'reg_desc', 'Enter how to register details ', 'How to Register', 'texteditor', '<h3>How to Register</h3><p>Click on the below link to register by going to our website. Just enter your detail and pay the registration fees.</p><p><a href &equiv; &acute;javascript:void(0)&acute; mce_href &equiv; &acute;javascript:void(0)&acute; class &equiv; &acute;button&acute;>Register Now</a></p>', '', 'How to Register', 13, 1, 1, 1, 0, 'both_side', 0, 0, '', '', '', ' '),
...
(28, 'organizer', 'Short Description', '0', 'organizer_desc', 'Short Description of Organizer. Basic HTML tags are allowed', 'Short Description', 'texteditor', '', '', 'Short Description', 28, 1, 0, 1, 0, 'both_side', 0, 0, '', '', '', '')");
}
...
(10, 'registration', 'user_photo', '',  'User Image', 'upload','', '', '', 10, 1, 0, 1, 1, '1', '', ''),
...
(14, 'registration', 'description', '',  'Description', 'textarea', '', '', '', 13, 1, 0, 0, 0, '1', '', '')
