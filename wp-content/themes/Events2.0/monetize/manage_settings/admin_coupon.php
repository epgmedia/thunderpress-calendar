...
<h4><?php _e($coupon_title,'templatic');?><a title="Back to manage coupons" class="l_back" name="btnviewlisting" href="<?php echo site_url()?>/wp-admin/admin.php?page=manage_settings#option_display_coupon"><?php _e('&laquo; Back to manage coupons','templatic'); ?></a></h4>
 <p class="notes_spec"><?php _e($coupon_msg,'templatic');?></p>
    ...
    <div class="section">
      ...
      <div class="description"><?php _e('You can define the coupon code here.','templatic');?></div>
    </div>
  </div> <!-- #end -->
  <div class="option option-select">
  ...
  <div class="option option-select"  >
    ...
    <div class="section">
      ...
      <div class="description"><?php _e('Specify the Discount type here. Whether you want to apply it in Percentage or in Amount.','templatic');?></div>
    </div>
  </div> <!-- #end -->
  ...
  <div class="option option-select"  >
    ...
    <div class="section">
      ...
      <div class="description"><?php _e('You can specify the discount amount here.','templatic');?></div>
    </div>
  </div> <!-- #end -->
