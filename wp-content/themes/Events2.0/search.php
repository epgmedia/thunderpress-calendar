...
<div id="wrapper" class="clearfix">
            ...
            <?php } ?>
              <?php if (is_paged()) $is_paged = true; ?>
            	 <?php if (is_search()) { ?>
                   ...
                   <?php }else{?>
                    <h1 class="cat_head" ><?php _e('Search Result');?> <?php if(isset($_REQUEST['skw']) && $_REQUEST['skw']!=''){   _e(" for: ".$_REQUEST['skw'],"templatic");  }?></h1>
                    <?php }?>
                    <?php } ?>
 ...
 <ul class="category_list_view">
      ...
      <?php } ?>
      <?php else: ?>
      <p class="notice_msg"><?php _e( 'Sorry, but nothing matched your search criteria. <br /> Please try again with some different criteria.'); ?></p>
      <?php endif; ?>
