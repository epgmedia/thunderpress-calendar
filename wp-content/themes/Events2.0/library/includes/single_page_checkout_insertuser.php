...
if($_POST && !$userInfo)
{
	...
	{
		$error =  __('Email for Publisher Information is Empty. Please enter Email, your all informations will sent to your Email.');	
		$_SESSION['userinset_error'] = $error;
		wp_redirect(get_option('siteurl').'?ptype=post_event&backandedit=1&usererror=1');
		exit;
	}
