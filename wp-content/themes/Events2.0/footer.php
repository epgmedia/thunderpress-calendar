...
<p class="copy"><span class="themeby"> <?php echo DESIGNED_TEXT; ?> </span>  <a href="http://templatic.com" title="templatic.com"><img src="<?php bloginfo('template_directory'); ?>/images/templatic.png" alt="" class="flogo" /></a> </p>
</div> <!-- footer #end -->
