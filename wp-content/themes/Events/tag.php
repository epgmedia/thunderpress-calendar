...
<div id="wrapper" class="clearfix">
  <div id="content" class="clearfix" >
      ...
      <div id="post-<?php the_ID(); ?>" class="posts">
                      ...
                      <p class="date"> <?php _e('By','templatic');?><?php the_author_posts_link(); ?> <?php _e('at','templatic');?>  <?php the_time('F j, Y') ?>  |   <?php the_time( $d ); ?>  | <a href="<?php the_permalink(); ?>#commentarea"><?php comments_number('0 Comment', '1 Comments', '% Comments'); ?> </a>   </p>
       ...
       ?>
                            ...
                            <p> <a href="<?php the_permalink(); ?>"><?php _e('Read more &raquo;','templatic');?> </a></p>
                            <?php } ?>
