...
/* 
Name : is_wp_admin()
Description : This function will show that user is in admin area or in front end
*/
...
/* 
Name : templ_add_admin_custom_css()
Description : Add the csss in admin area
*/
...
/*
Name : templ_is_third_party_seo
Description : SEO third party enabled/disabled BOF
*/
...
/*
Name : templ_seo_meta_content
Description : It returns Meta Content, Description and Noindex settings for SEO
*/
...
/*
Name : templ_seo_title
Description : It returns SEO page title
*/
...
/*
Condition to check is SEO third party plugin is enable/disable from basic settings
*/
if(strtolower(get_option('ptthemes_use_third_party_data')) == 'no'){
 /* filter for add title */
 add_filter('wp_title', 'templ_seo_title');
}

/*
Name: templ_top_header_navigation_content
Description : Function will shows the top header navigation menu contents, It will return the menu, templ_get_top_header_navigation action is use for fetch the results.
*/
...
function templ_sendEmail($fromEmail,$fromEmailName,$toEmail,$toEmailName,$subject,$message,$extra='')
{
	...
	{ 
		...
		imap_mail($toEmail, $subject, $message, $headers);
		}elseif(get_option('ptthemes_notification_type')){
