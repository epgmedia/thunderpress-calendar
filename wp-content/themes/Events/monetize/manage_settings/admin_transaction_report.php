...
<p class="notes_spec"> <?php _e('You can view whole transaction report in this section. You can search for a transaction or sort them according to the payment gateway too. It also allows you to export all the transactions in a CSV file.','templatic');?></p>
    ...
    <form method="post" action="<?php echo home_url('/wp-admin/admin.php?page=manage_settings#option_transaction_settings');?>" name="ordersearch_frm">
        <table cellspacing="1" cellpadding="4" border="0" width="100%" style="padding:5px;">
			...
			<tr>			
				...
				<td valign="top" >&nbsp;&nbsp;<input type="submit" name="Search" value="<?php _e('Search','templatic'); ?>" class="button-secondary action"  />&nbsp;<input type="reset" name="Default Reset" value="<?php _e('Reset','templatic'); ?>" onclick="window.location.href='<?php echo $targetpage;?>'" class="button-secondary action" /></td>
...
{
?>
<strong><?php _e('No Transaction Available','templatic'); ?></strong>
      <?php
}
?>
<script>
