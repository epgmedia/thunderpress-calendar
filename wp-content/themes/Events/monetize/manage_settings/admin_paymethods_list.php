...
<p class="notes_spec"> <?php _e('We provide eight different payment gateways in the theme. You can select which one you want to use and easily deactivate other payment gateways','templatic');?></p>
