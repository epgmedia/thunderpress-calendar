...
<div class="container-01">
	<div class="graybox">
        <form name="loginform" id="loginform" action="<?php echo home_url().'/?page=register'; ?>" method="post" >
          ...
          <p class="rember">
            ...
            <span style="position:relative;"><?php echo REMEMBER_ON_COMPUTER_TEXT; ?></span>
          </p>
          <input style="margin-left:0px;" class="b_signin" type="submit" value="<?php echo SIGN_IN_BUTTON;?>"  name="submit" />
        ...
        <form name="lostpasswordform" id="lostpasswordform" action="<?php echo get_option( 'home' ).'/?page=login&amp;action=lostpassword'; ?>" method="post">
          ...
          <input type="submit" name="get_new_password" value="<?php echo GET_NEW_PW_TEXT;?>" style="margin:0px;" class="b_signin " />
        </form>
		<?php
