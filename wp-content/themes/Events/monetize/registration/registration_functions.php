...
/* CODE TO FETCH USER CUSTOM FIELDS ON PROFILE PAGE */
...
/*
NAME : FETCH USER CUSTOM FIELDS DATA
DESCRIPTION : THIS FUNCTION FETCHES USER CUSTOM FIELDS DATA ON AUTHOR PAGE
*/
add_action('templ_page_title_below','get_user_meta_author_page');
function get_user_meta_author_page()
{
