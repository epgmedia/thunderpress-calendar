...
/*
NAME : ADD IMAGE FILE
DESCRIPTION : THIS FILE WILL BE CALLED IF THE USER ADDS IMAGES (ON SUBMIT EVENT PAGE) WHILE ADDING OR EDITING AN EVENT.
*/
...
<div id="uploadimage" class="upload" ><span>Upload Image</span></div><span class="message_note" id="status"></span>
