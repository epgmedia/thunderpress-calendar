...
?>
    ...
    <p class="notes_spec"><?php _e('Custom fields help you ask additional information from listing adders. You can setup these fields as per category basis, which means a field meant for &lsquo;Exhibition&rsquo; category won&rsquo;t appear in &lsquo;Kids&rsquo; category. ','templatic');?></p>
...
<table width="100%"  class="widefat post" >
  <thead>
    <tr>
      ...
      <th><?php _e('Add Fields For','templatic');?></th>
	...
	?>
	 ...
	 <img src="<?php echo get_template_directory_uri(); ?>/images/edit.png" alt="<?php _e('Edit Field','templatic');?>" border="0" /></a> <?php if($post_meta_info_obj->is_delete=='1'){?>&nbsp;&nbsp;
      ...
      <tr>
        ...
        <td><?php _e('Add Fields For','templatic')?> : <strong><?php echo $post_meta_info_obj->post_type;?></strong></td>
...
<li> <img title="<?php _e('Locked','templatic');?>" src="<?php echo get_template_directory_uri(); ?>/images/lock.gif" alt="<?php _e('Locked','templatic');?>" border="0" /><?php _e('This field is undeletable (locked). To unlock it, click &lsquo;Edit&rsquo; and set &lsquo;Is deletable?&rsquo; to &lsquo;Yes&rsquo;','templatic');?></li>
</ul>
</div>