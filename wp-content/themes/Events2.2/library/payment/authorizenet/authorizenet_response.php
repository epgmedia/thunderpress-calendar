...
switch ($a->process()) {
   ...
   case 1:  // Successs
	...
	$redirectUrl = get_option('home')."/?ptype=payment_success&pid=".$last_postid;
...
//if(!$paymentFlag)
//{
	//wp_redirect(get_option('home').'/?ptype=checkout&paymentmethod='. $_REQUEST['paymentmethod'].'&shippingmethod='.$_REQUEST['shippingmethod']);
	//exit;
//}
?>