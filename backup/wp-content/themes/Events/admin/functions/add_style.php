...
/* 
Feature : theme skins
descriptiion : below code will show the effects when user change the theme skins from backend.
*/
if(get_option('ptthemes_fonts')){?>
...
<?php }
/* wordpress function which fetch all styles as per skins */
