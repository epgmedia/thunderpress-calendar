...
<div id="respond">
    ...
    <?php if ( get_option('comment_registration') && !$user_ID ) : ?>
        <p><?php _e('You must be','templatic'); ?> <a href="<?php echo get_option('home'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>"><?php  _e('logged in','templatic'); ?></a> <?php _e('to post a comment','templatic'); ?>.</p>
    <?php else : ?>	
        ...
        <?php if ( $user_ID ) : ?>
                <p><?php  _e('logged in','templatic'); ?> &rarr; <a href="<?php echo get_option('home'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(); ?>" title="Log out of this account"><?php _e('Logout','templatic'); ?> &raquo;</a></p>
            <?php else : ?>
                <p class="commpadd clearfix">
